...
innerAudioContext.src =
  "cloud://test-6gbljcgx7c5a85df.7465-test-6gbljcgx7c5a85df-1304542776/applaws-music.mp3"; // 音频资源的地址
...
Page({
    ...
    this.setData(
      {
        ...
        preLoadProgressPercent:
          ((this.data.preLoadCount + 1) / this.data.cacheImageList.length) *
          100,
      },
      () => {
        //  3秒钟一定关闭loading
    ...
    Utils.BaiduAISdk.identifyFace({
      ...
      success: function (data) {
        ...
        try {
          ...
          glass =
            data.result.face_list[0].glasses.type === "none"
              ? "no-glass"
              : "glass";
        } catch (error) {}
        self.setData({
  ...
  shutRecording: function () {
    ...
    recorderManager.onStop((res) => {
      ...
      wx.cloud.uploadFile({
        cloudPath:
          "sounds/" + timestamp + "-" + this.randomNum(10000, 99999) + ".mp3",
        ...
        success: (res) => {
          ...
          that.setData({
            soundUrl: `https://${
              that.data.cloudStorageId
            }.tcb.qcloud.la/sounds${this.midstr(res.fileID)}`,
          });
          wx.hideLoading();
        },
      });
  ...
  onShareAppMessage: function (res) {
    ...
    if (res.from === "button") {
      ...
      return {
        title:
          "Applaws圣诞把“爱”说出来，有好礼！有惊喜！录制语音祝福，定制只属于您的心愿水晶球！",
